...
const MovieBox = ({ list }) => {
    ...
    const handleShow = () => {setShow(true); fetchingConst= !fetchingConst}
    
    const [j, setJ] = useState([]);
    console.log(j)
    
    useEffect(() => {
        fetch(`https://api.themoviedb.org/3/movie/${list.id}?api_key=dea5d1d72df02ec5cc84f8afd612808b&language=es-MX`)
